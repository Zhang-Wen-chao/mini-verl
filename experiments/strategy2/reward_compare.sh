#!/bin/bash
# Strategy 2: process reward vs outcome reward ablation
# Usage: PROCESS_REWARD=1 bash reward_compare.sh   (process-reward arm)
#        bash reward_compare.sh                     (outcome-reward arm, default)
