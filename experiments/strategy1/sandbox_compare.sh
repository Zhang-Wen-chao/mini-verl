#!/bin/bash
# Strategy 1: online anti-cheat ablation (sandbox ON vs OFF)
# Usage: SANDOX_OFF=1 bash strategy1_sandbox_compare.sh  (off arm)
#        bash strategy1_sandbox_compare.sh                 (on arm, default)
# Sets up ray, launches retool GRPO with generate_with_retool from strategy1/.
set -ex
...
SCRIPT_DIR=$BASE/experiments/strategy1
mkdir -p "$SAVE_DIR"
