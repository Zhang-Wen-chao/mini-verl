...
| 项目 | 状态 | 原因 / 位置 |
|---|---|---|
| LLM PPO actor-critic / GAE | 校准准备完成，未执行 | 真实 4B 的 GAE/Critic 1-step gate 已准备；当前被 L20 CUDA runtime 兼容性阻断，详见 [PPO 可行性记录](../official_verl/docs/runlogs/2026-08-22-qwen3.5-4b-ppo-gae-feasibility-plan.md) |
